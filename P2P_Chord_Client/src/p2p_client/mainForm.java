...
public class mainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jCheckBox3.setText("Toggle Server");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jFileChooser1.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            if(!hostModel.contains(jFileChooser1.getSelectedFile().getName())) {
                fhs.addFile(jFileChooser1.getSelectedFile());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        List<String> responses = fhs.findFile(jTextField2.getText());
        searchModel.clear();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            if(location.length!=3)
                throw new Exception();
            port = Integer.parseInt(location[2]);
        } catch (Exception e) {
            System.err.println("Response from server was not correctly formatted");
            return;
        }
        
        fileDownload fd = new fileDownload(location[1], port, location[0]);
        fd.start();
    ...
    private void jCheckBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox3ActionPerformed
        ...
        jButton1.setEnabled(jCheckBox3.isSelected());
        jList1.setEnabled(jCheckBox3.isSelected());
        ...
        if(!jCheckBox3.isSelected()) {
            ...
            fhs = new fileHostServer((Integer) jSpinner2.getValue(), 8);
            kUp = new keyUpdater(keyModel, fhs);
            fhs.startChord();
            kUp.start();
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        if(!jCheckBox1.isSelected()) {
            ...
            fhs = new fileHostServer((Integer) jSpinner2.getValue(), 8);
            kUp = new keyUpdater(keyModel, fhs);
            fhs.joinChord(jTextField3.getText(), (Integer)jSpinner3.getValue());
            kUp.start();
            if(jCheckBox2.isSelected()) {
                List<File> l = flh.loadFiles();
                for(File f : l) {
